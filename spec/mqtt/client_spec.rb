...
describe MQTT::Client do
  ...
  describe "#connect" do
    ...
    context "when no client id is given" do
  ...
  describe ".connect" do
    it "creates a new client object" do
      client = instance_double(MQTT::Client)
  ...
  describe "#disconnect" do
    before do
      thread = instance_double(Thread, alive?: true, kill: true, join: nil)
      client.instance_variable_set(:@socket, socket)
  ...
  describe "#publish" do
      ...
      Class.new(MQTT::Client) do
        ...
        def register_for_ack(packet)
          if @injected_pubacks.key?(packet.id)
            ...
            return self.class.const_get(:PendingAck).new(packet, queue)
          end
    ...
    it "resends packets" do
      ...
      expect(received_packets[0].duplicate).to be false
      expect(received_packets[1].duplicate).to be true
    end
  ...
  describe "#receive_packet" do
    ...
    let(:read_queue) { client.instance_variable_get(:@read_queue) }
  ...
  describe "#handle_keep_alives" do
    ...
    it "sends a ping packet if one is due" do
      ...
      expect(client.instance_variable_get(:@keep_alive_sent)).to be true
    end
